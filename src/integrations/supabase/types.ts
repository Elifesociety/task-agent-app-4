...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      survey_responses: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "survey_responses_panchayath_id_fkey"
          ...
          {
            foreignKeyName: "survey_responses_program_id_fkey"
            columns: ["program_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "survey_responses_sub_category_id_fkey"
            columns: ["sub_category_id"]
            isOneToOne: false
            referencedRelation: "sub_categories"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      district_type: "Malappuram" | "Kozhikode" | "Palakkad"
    }
    CompositeTypes: {
      [_ in never]: never
    }
